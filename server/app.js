...
app.post('/api/conversation', async (req, res) => {
    try {
        ...
        if (existingConversation) {
            // retourner l'id de conversation existante
            res.status(200).json({ conversationId: existingConversation._id });
        } else {
            // si elle n'existe pas en creeer une nouvelle
...
//         res.status(200).json({ conversationId: savedConversation._id });;
//     } catch (error) {
//         console.log(error, 'Error')
//     }
// })
